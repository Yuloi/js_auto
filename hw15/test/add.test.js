...
describe('Testing Add method from calculator class', function () {
	...
	describe('Positive cases for Add method', function () {
		...
		it('Function is able to sum two negative integers', async function (){
			let result = calc.add(-10, -4);
			expect(result).to.equal(-14);
		});
		it('Function is able to sum positive int and negative int', async function (){
			let result = calc.add(4,-1);
			expect(result).to.be.equal(3);
		});
		it('Function is able to sum two positive float with the same amount of numbers after dot', async function (){
			let result = calc.add(4.28, 0.14);
			expect(result).to.be.equal(4.42);
		});
		it('Function is able to sum two negative float with different amount of numbers after dot', async function (){
			let result = calc.add(-10.1, -2.245);
			expect(result).to.be.equal(-12.345);
		});
		it('Function is able to sum negative float and positive int', async function (){
			let result = calc.add(-2.245, 1);
			expect(result).to.be.equal(-1.245);
		});
		it('Function is able to sum zero', async function (){
			let result = calc.add(0);
			expect(result).to.be.equal(0);
		});
		it('Function is able to sum zero and positive float', async function (){
			let result = calc.add(0,0.34);
			expect(result).to.be.equal(0.34);
		});
		it('Function is able to sum zero and negative float', async function (){
			let result = calc.add(-14.980, 0);
			expect(result).to.be.equal(-14.980);
		});
		it('Function is able to sum zero and positive int', async function (){
			let result = calc.add(0,10);
			expect(result).to.be.equal(10);
		});
		it('Function is able to sum zero and negative int', async function (){
			let result = calc.add(0,-1);
			expect(result).to.be.equal(-1);
		});
		it('Function is able to sum big numbers', async function (){
			let result = calc.add(10e5,50e2,32e2);
			expect(result).to.be.equal(1008200);
		});
		it('Function is able to sum floats with big amount of numbers after dot', async function (){
